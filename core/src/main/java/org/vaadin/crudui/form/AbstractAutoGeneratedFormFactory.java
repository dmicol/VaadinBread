...
import org.vaadin.data.JpaValidationBinder;
 ...
 */
public abstract class AbstractAutoGeneratedFormFactory<T, E extends Enum<E>> extends AbstractFormFactory<T, E> implements FormFactory<T> {
...
//    }
    ...
    @Override
    public void showError(Operation operation, Exception e) {
