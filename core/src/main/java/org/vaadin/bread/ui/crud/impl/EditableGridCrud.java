...
import org.vaadin.bread.ui.form.BeanButtonFormConfiguration;
...
public class EditableGridCrud<T> extends GridCrud<T> {
    ...
    public class GridOnlyCrudFormFactory<T> extends AbstractAutoGeneratedFormFactory<T> {
        ...
        @Override
        public AbstractOrderedLayout buildNewForm(OperationMode operationMode, OperationAction[] operationActions, T domainObject, boolean readOnly) {
